<template>
    ...
    <Form ref="loginForm" autoComplete="on" :model="loginForm"   class="card-box login-form">
        ...
        <!-- <Form-item prop="type">
            <select style="background-color: #ededed00;color: white;">
              <option value="admin" style="background-color: #ededed00;color: white;">管理员</Option>
              <option value="team" style="background-color: #ededed00;color: white;">代表队</Option>
              <option value="referee" style="background-color: #ededed00;color: white;">裁判</Option>
            </select>
        </Form-item> -->
        <Form-item>
