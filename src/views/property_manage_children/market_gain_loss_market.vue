  ...
  <div class="animated fadeIn">
    <Row>
      ...
      title="Common Modal dialog box title">
        ...
        <div id="box">
          <h1 style="text-align:center">市场营销服务收支利情况表-分市场</h1>
          <h6 style="text-align:center" >{{file.author}} {{file.time}}</h6>
          <table id="tb_3" cellspacing="0">
              <tr style="display:none"><td><span ></span></td><td colspan="14" t="s" id="sjs-B1"><span >市场营销服务收支利情况表</span></td><td><span ></span></td><td><span ></span></td></tr><tr style="display:none"><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td t="s" id="sjs-O2"><span ><span style="font-size:11;">会铁通月16</span><span style="font-size:11;">01</span><span style="font-size:11;">表</span></span></td><td><span ></span></td><td><span ></span></td></tr><tr style="display:none"><td t="s" id="sjs-A3"><span >编制单位：中移铁通有限公司内蒙古分公司(合并)</span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td t="s" id="sjs-G3"><span >2019年6月</span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td><span ></span></td><td t="s" id="sjs-O3"><span >金额单位：元</span></td><td><span ></span></td><td><span ></span></td></tr><tr><td rowspan="1" colspan="2" t="s" id="sjs-A4"><span >项&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目</span></td><td rowspan="1" t="s" id="sjs-C4"><span >行次</span></td>
              <td t="s" id="sjs-D4"><span >中国移动</span></td>
              <td t="s" id="sjs-E4"><span >中国电信</span></td>
              <td t="s" id="sjs-G4"><span >中国联通</span></td>
              <td t="s" id="sjs-H4"><span >中国铁路总公司</span></td>
              <td t="s" id="sjs-I4"><span >中国铁塔</span></td>
              <td t="s" id="sjs-J4"><span >地铁公司</span></td>
              <td t="s" id="sjs-K4"><span >其他市场</span></td>
              <td t="s" id="sjs-L4"><span >待分摊</span></td>
              <td t="s" id="sjs-M4"><span >合计</span></td>
              </tr><tr><td colspan="2" t="s" id="sjs-A5"><span >栏&nbsp;&nbsp;&nbsp;&nbsp;次</span></td><td t="s" id="sjs-C5"><span >——</span></td><td t="n" id="sjs-D6"><span >1</span></td><td t="n" id="sjs-E5"><span >2</span></td><td t="n" id="sjs-F5"><span >3</span></td><td t="n" id="sjs-G5"><span >4</span></td><td t="n" id="sjs-H5"><span >5</span></td><td t="n" id="sjs-I5"><span >6</span></td><td t="n" id="sjs-J5"><span >7</span></td><td t="n" id="sjs-K5"><span >8</span></td><td t="n" id="sjs-L5"><span >9</span></td></tr><tr><td t="s" id="sjs-A7"><span >收支</span></td><td t="s" id="sjs-B7"><span >一、收入</span></td><td t="n" id="sjs-C7"><span >1</span></td>
             ...
             </tr><tr><td t="s" id="sjs-A58"><span >利润</span></td><td t="s" id="sjs-B58"><span >三、营业利润</span></td><td t="n" id="sjs-C58"><span >53</span></td>
...
import { read_market_gain_loss_market } from "../../read_market_gain_loss_market";
var project={
        business_type:"",
        income:{
            name:"收入",
...
export default {
  ...
  methods: {
    upload() {
      ...
      data = read_market_gain_loss_market(data);
      util._fetch('finance/','POST',{"data":data,"table_name":"市场营销服务收支利情况表-分市场","date":this.time})
                .then(res=>{
                    console.log(res)
                    this.init()
    ...
    file1(e) {
      ...
      reader.onload = function(e) {
        ...
        that.file = read_market_gain_loss_market(f);
        // that.create_table()
    ...
    create_table(file){
      ...
      // this.table_data_show=temp_table_data
    },
    ...
    init(){
        util._fetch('finance/MarketingManagementMarket','get')
        .then(res=>{
            console.log(res)
            if(res.length<=0){
    ...
    remove(){
        this.$Modal.confirm({
            ...
            onOk:()=>{
                util._fetch('finance/MarketingManagementMarket?id='+this.all_file[this.table_index].id,'delete')
                .then(res=>{
                    console.log(res)
